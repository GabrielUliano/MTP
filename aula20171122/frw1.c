...
#include <stdlib.h>
#define MAXCHAR 256
void captura(char * nome, int * idade_em_anos,
    ...
    fscanf(stdin,"%d",idade_em_anos); while(!(c=getchar()));
    fprintf(stdout,"Entre com a altura [metros]: ");
    fscanf(stdin,"%f",altura_em_metros); while(!(c=getchar()));
}
...
int main() {
    ...
    printf("Entre com um arquivo (sem espacos): ");
